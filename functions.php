...
if (!function_exists('bootstrapBasicSetup')) {
    ...
    {
        /**
         * Make theme available for translationm
 ...
 register_nav_menus( array(
    'header-menu' => __( 'Header Menu', 'blueitgroup' ),
    'staffing-menu' => __( 'Staffing Menu', 'blueitgroup' ),
    'consulting-menu' => __( 'Consulting Menu', 'blueitgroup' ),
    'advisory-menu' => __( 'Advisory Menu', 'blueitgroup' ),
    'sap-menu' => __( 'SAP Menu', 'blueitgroup' ),
        'ibm-menu' => __( 'IBM Menu', 'blueitgroup' ),
        'company-menu' => __( 'Company Menu', 'blueitgroup' ),
) );
